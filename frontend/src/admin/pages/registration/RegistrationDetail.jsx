  ...
  return isLoading ? (
    ...
    <div className="min-h-[78vh]">
      ...
      <div>
              ...
              ? booking.roomBookings.flatMap((bookingId) => {
                  return roomsBooking.data
                    ...
                    .map((roomBooking) => {
                      ...
                      if (room) {
                        return (
                          <tr key={roomBooking._id} className="text-center">
                            <td className="py-2">{roomType.name}</td>
                            <td>{room.roomNumber}</td>
                            <td>{roomBooking.headcount}</td>
                          </tr>
                        );
                      }
                      return null;
        ...
        <div className={`w-1/2 py-3 ${booking.serviceBookings ? "" : "flex"}`}>
          ...
          {booking.serviceBookings ? (
            <table className="border border-gray-300 w-full">
              ...
              {booking.serviceBookings && servicesBooking.data && services.data
                ? booking.serviceBookings.flatMap((bookingId) => {
                    return servicesBooking.data
                      .filter(
                        (serviceBooking) => serviceBooking._id === bookingId
                      )
