...
const EditRegistration = () => {
  ...
  const editDataBooking = async () => {
    try {
      setIsLoading(true);
      const data = await editBooking(id, roomInteraction, serviceBooking);
      console.log(data);
      if (data.code === 0) {
        ...
        <div>
          {booking.roomInteraction === "Chưa nhận phòng" ? (
            <div className="py-2 text-gray-500">
              <p className="text-gray-500 mb-2">Room Category Name</p>
              <select
              ...
              >
                ...
                <option value="Đã hủy phòng">Đã hủy phòng</option>
              </select>
            </div>
          ) : (
            <>
              ...
              <div className="py-2 text-gray-500 w-full">
                ...
                <table className="border border-gray-300 w-3/4">
                  ...
                  {serviceBooking
                    ? serviceBooking.map((booking, index) => (
