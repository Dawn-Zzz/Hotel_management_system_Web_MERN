      ...
      <div className="flex flex-col justify-between bg-white rounded-xl shadow-md">
        ...
        <table className=" rounded-lg text-left m-4 mt-0 bg-white overflow-hidden">
          <tr className="border bg-gray-100">
            <th className="text-gray-500 font-medium py-4 pl-4">Staff Name</th>
            <th className="text-gray-500 font-medium py-4">Date Of Birth</th>
            <th className="text-gray-500 font-medium py-4">Phone Number</th>
            <th className="text-gray-500 font-medium py-4">ID Number</th>
            <th className="text-gray-500 font-medium py-4">Job Title</th>
            <th className="text-gray-500 font-medium text-center">Action</th>
          </tr>
          {data.map((staff) => (
            <tr key={staff._id} className="border">
              <td className="py-4 text-gray-500 pl-4">{staff.name}</td>
              <td className="py-4 text-gray-500">
                {new Date(staff.dateOfBirth).toLocaleDateString()}
              </td>
              <td className="py-4 text-gray-500">{staff.phoneNumber}</td>
