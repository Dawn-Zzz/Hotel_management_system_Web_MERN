    ...
    <div>
      ...
      <table className="w-full text-left mt-6">
        <tr className="border-y">
          <th className="text-gray-500 font-medium py-4">Guest Name</th>
          ...
          <th className="text-gray-500 font-medium py-4">Guest Categories</th>
        ...
        {data.map((guest) => (
          <tr key={guest._id} className="border-b">
            ...
            <td className="py-4 text-gray-500">{guest.IDnumber}</td>
            <td className="py-4 text-gray-500">{guest.guestCategories}</td>
            <td className="py-4 text-gray-500">
              <Link
