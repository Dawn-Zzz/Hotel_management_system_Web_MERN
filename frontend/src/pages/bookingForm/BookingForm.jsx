...
const BookingForm = () => {
    ...
    const [guestQuantity, setGuestQuantity] = useState(
        rooms.map((room) => ({
            ...
            quantity: new Array(Number(room.value)).fill(1),
        }))
    );
    ...
    const handleGuestQuantityChange = (index, i, e) => {
        ...
        // console.log(guestQuantity[index][i], Number(e.target.value));
        console.log(newArr[index][i], e.target.value);
    };
    ...
    // console.log("hihjihsiodsa", rooms);
    useEffect(() => {
