...
const Room = () => {
  ...
  return isLoading ? (
    ...
    <div className="w-full bg-white flex flex-col items-center">
      ...
      <div className="relative w-3/5 bg-white shadow-xl p-8 rounded-xl -top-[70px] flex items-end justify-between">
        ...
        <div className="w-2/5">
          ...
          <input
            type="date"
            className={`border-2 w-full px-4 py-2 rounded-md outline-none ${
              !bookedDate.checkin ? "opacity-50 cursor-default" : ""
            }`}
      ...
      <Link className="py-3 mb-8 px-16 bg-black text-white" to="/booking">
        Submit
      </Link>
      <div className="flex flex-col items-center bg-slate-100 pt-12 pb-16 w-full">
        <p className="text-[52px] font-serif font-semibold">Great Offers</p>
        ...
        <div className="w-3/5 h-[540px] m-auto py-4 px-2 flex flex-col items-center mb-48">
          <div className="flex h-[350px] w-[1200px]">
            ...
            <div className="flex flex-col justify-center p-8 bg-white w-1/2">
              <p className="text-[40px] font-semibold">Family Room</p>
              <p className="my-8">
                Far far away, behind the word mountains, far from the countries
              ...
              <p className="text-indigo-600 font-bold text-2xl ">750.000VND</p>
            </div>
          </div>
          <div className="flex h-[350px] w-[1200px]">
            <div className="flex flex-col justify-center p-8 bg-white w-1/2">
              <p className="text-[40px] font-semibold">Suite Room</p>
              <p className="my-8">
                Far far away, behind the word mountains, far from the countries
                Vokalia and Consonantia, there live the blind texts. Separated
                they live in Bookmarksgrove right at the coast of the Semantics,
